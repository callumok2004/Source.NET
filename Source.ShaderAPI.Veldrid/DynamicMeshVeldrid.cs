...
public unsafe class DynamicMeshVeldrid : MeshVeldrid
{
	bool HasDrawn;
	bool VertexOverride;
	bool IndexOverride;
	...
	public override void OverrideVertexBuffer(VertexBufferVeldrid vertexBuffer) {
		UseVertexBuffer(vertexBuffer);
		VertexOverride = true;
	}

	public override void OverrideIndexBuffer(IndexBufferVeldrid indexBuffer) {
